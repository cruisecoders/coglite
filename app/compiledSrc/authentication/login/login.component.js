...
var LoginComponent = (function () {
    // intilialization
    function LoginComponent(router, authService, messageService, localStorageUtilityService, userService) {
        this.router = router;
    ...
    LoginComponent.prototype.login = function () {
        ...
        this.authService.login(this.userName, this.password).subscribe(function (result) {
            ...
            _this.messageService.showMessage({ type: 'success', message: 'Logged In Successfully', duration: 3000 });
